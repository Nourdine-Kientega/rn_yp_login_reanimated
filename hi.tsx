...
export default function LoginScreene() {
    ...
    <View  style={tw`bg-white h-full w-full`} >
        ...
        <View style={tw`h-full w-full flex justify-around pt-50 pb-10`}>
          ...
          <View style={tw` flex items-center`}>
            <Animated.Text entering={FadeInUp.duration(1000).springify()} style={tw`text-white font-bold tracking-wider text-5xl `}>Login</Animated.Text>
          </View>
          ...
          <View style={tw`flex items-center mx-4 gap-y-4`}>
            ...
            <Animated.View entering={FadeInDown.delay(300).duration(1000).springify()} style={tw`w-full`}>
